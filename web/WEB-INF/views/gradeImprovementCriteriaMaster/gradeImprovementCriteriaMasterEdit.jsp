<%-- 
    Document   : gradeImprovementCriteriaMasterEdit
    Created on : Mar 12, 2019, 12:16:49 PM
    ...
    <div class="col-lg-12 container">
        ...
        <div class="row col-lg-12 form-group" >
            <div class="row col-lg-6 form-group">
                ...
                <div class="col-sm-9 col-lg-7 col-xs-12 col-md-6">
                    <input type="text" name="programCode" id="programCode" readonly="true" value="${data[0][1]}"   class="form-control"  data-validation-error-msg="Please select program code!">
                </div>
            </div>
            <div class="row col-lg-6 form-group">
                ...
                <div class="col-sm-9 col-lg-7 col-xs-12 col-md-6">
                    <input type="text" name="cgpaFrom" id="cgpaRangeFrom" maxlength="5" value="${data[0][3]}" data-validation-help="Max Length is 5" data-validation="number" data-validation-allowing="float" placeholder="Enter CGPA" class="form-control"  data-validation-error-msg="Please enter cgpa range from!">
                </div>
            </div>
        </div> 
        <div class="row col-lg-12 form-group" >
            <div class="row col-lg-6 form-group">
                ...
                <div class="col-sm-9 col-lg-7 col-xs-12 col-md-6">
                    <input type="text" name="cgpaTo" id="cgpaRangeUpTo" maxlength="5" value="${data[0][4]}"data-validation-help="Max Length is 5" data-validation="number" data-validation-allowing="float" placeholder="Enter CGPA" class="form-control" data-validation-error-msg="Please enter cgpa range upto!">
                </div>
            </div>
            <div class="row col-lg-6 form-group">
                ...
                <div class="col-sm-9 col-lg-7 col-xs-12 col-md-6">
                    <input type="text"  data-toggle="tooltip" title="Grade Value i.e A,B,C and so on " onkeyup="this.value = this.value.toUpperCase();" name="applicablegrades" id="applicableGrades"value="${data[0][5]}" maxlength="10" data-validation-help="Max Length is 8" data-validation="required" placeholder="Enter Applicable Grades" class="form-control" data-validation-error-msg="Please enter applicable grades!">
                </div>
            </div>
        </div>        
        </div>        
        <div class="col-lg-12 container">
            ...
            <div class="row col-lg-12 form-group" ><br>
                <div class="row col-lg-6 form-group">
                    <label  class="col-sm-7 control-label" style="text-align:left">If student gets Fail in GIP exam:</label>
                   <div class="col-sm-10 col-sm-offset-2"><br>
                        <c:if test="${data[0][7]=='L'}">
                        ...
                        <c:if test="${data[0][7]=='C'}">
                            <input type="radio" name="assignGrade" id="Last" value="L"   > Assign Previous Passing Grade<br>
                            <input type="radio" name="assignGrade" id="Current" value="C"   checked="true"> Assign Current Fail Grade<br>
                        </c:if>
                    </div>
                </div>
            </div>        
            <div class="row col-lg-12 form-group" >
                <div class="row col-lg-6 form-group">
                    <label  class="col-sm-10 control-label" style="text-align:left">Grade to be assign If student Passed in GIP exam:</label>
                </div> <div class="col-sm-10 col-sm-offset-1"> 
                    <br><div id="test" class="row col-lg-12 form-group table-wrapper-scroll-y2" style="border:1px solid lightgray;margin-top:-15px">
                        <table id="datatable" class="box table table-hover table-condensed table-bordered" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${grades}" var="list">
                                    <% int flag = 1;%>
                                    <c:forEach items="${datadetail}" var="datadetail"> 
                                        <c:if test="${datadetail==list[1]}">
                                            <tr id="${list[0]}:${list[1]}">
                                                <td align="center">
                                                    <%=i%>
                                                </td>
                                                <td><input type="checkbox" name="chk<%=i%>" value="${list[1]}" checked="true"/></td>
                                                <td>${list[2]}</td>
                                                <td>${list[3]}</td>
                                            </tr>
                                            <%  flag = 0;%>
        ...
        <input type="hidden" name="programid" value="${data[0][0]}">     
                ...
                $.validate(
                        {
                            ...
                            onSuccess: function (e) {
                                $.ajax({
                                    type: "POST",
                                    url: "gradeImprovementCriteriaMaster/update",
