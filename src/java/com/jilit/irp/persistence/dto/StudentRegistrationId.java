 ...
 */
public class StudentRegistrationId  implements java.io.Serializable {
    ...
    public StudentRegistrationId(String instituteid, String registrationid, String studentid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof StudentRegistrationId) ) return false;
		 StudentRegistrationId castOther = ( StudentRegistrationId ) other;
