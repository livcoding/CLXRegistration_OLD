...
/**
 * StudentsubjectfacultychoicesId generated by hbm2java
 */
public class StudentSubjectFacultyChoicesId  implements java.io.Serializable {
     ...
     private byte preferenceno;

    public StudentSubjectFacultyChoicesId() {
    }

    public StudentSubjectFacultyChoicesId(String instituteid, String registrationid,String studentid, byte stynumber, String subjectid, String subjectcomponentid, byte preferenceno) {
    ...
    public byte getPreferenceno() {
        return this.preferenceno;
    }
    
    public void setPreferenceno(byte preferenceno) {
        this.preferenceno = preferenceno;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof StudentSubjectFacultyChoicesId) ) return false;
		 StudentSubjectFacultyChoicesId castOther = ( StudentSubjectFacultyChoicesId ) other;
 ...
 && (this.getPreferenceno()==castOther.getPreferenceno());
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + this.getPreferenceno();
         return result;
   }   
