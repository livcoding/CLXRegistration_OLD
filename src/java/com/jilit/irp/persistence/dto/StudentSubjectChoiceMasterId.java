...
/**
 * StudentsubjectchoicemasterId generated by hbm2java
 */
public class StudentSubjectChoiceMasterId  implements java.io.Serializable {
    ...
    public StudentSubjectChoiceMasterId() {
    }

    public StudentSubjectChoiceMasterId(String instituteid, String registrationid, byte stynumber, String studentid, String subjectid) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof StudentSubjectChoiceMasterId) ) return false;
		 StudentSubjectChoiceMasterId castOther = ( StudentSubjectChoiceMasterId ) other;
