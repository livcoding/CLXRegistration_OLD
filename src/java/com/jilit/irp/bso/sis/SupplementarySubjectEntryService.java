 ...
 */
@Service
public class SupplementarySubjectEntryService implements SupplementarySubjectEntryIService {
    ...
    public void getSemesterCode(ModelMap model) {
        ...
        try {
            ...
            list = (List<Object[]>) daoFactory.getRegistrationMasterDAO().getRegistrationCodeForSupplementary(instituteid);
    ...
    public List getStudents(HttpServletRequest request) {
        ...
        try {
            ...
            String[] regid = rid.split("~@~");
            String registrationid = regid[0];
            String parentregistrationid = regid[1];
            list = (List) daoFactory.getStudentMasterDAO().getStudentsForSupplementary(instituteid, parentregistrationid);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return list;
    ...
    public List getSubjectCode(HttpServletRequest request) {
        ...
        try {
            ...
            String parentregistrationid = regid[1];
            String studentid = request.getParameter("studentid").split("~@~")[0];
            list = (List) daoFactory.getSubjectMasterDAO().getSubjectsForSupplementary(instituteid, registrationid, parentregistrationid, studentid);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return list;
    ...
    public List saveSupplementarySubjects(HttpServletRequest request) {
        ...
        try {
            ...
            String instituteid = jirpsession.getJsessionInfo().getSelectedinstituteid();
            String rid = request.getParameter("semestercode");
            String[] regid = rid.split("~@~");
            String registrationid = regid[0];
            String parentregistrationid = regid[1];
            ...
            String subjectid = request.getParameter("subjectcode").split("~@~")[0];
            ...
            String parameterstytype = daoFactory.getRegistrationParametersDAO().getParametersValue(instituteid, "SUBREG2.7");
            if (parameterstytype.length() > 3) {
                list.add("Please Check and Correct the value of Parameter SUBREG2.7 in Registration Parameters Form...!");
                return list;
            }
            String parameterfeecal = daoFactory.getRegistrationParametersDAO().getParametersValue(instituteid, "SUBREG3.3");
            ...
            if (parameterfeecal.equals("F")) {
                if (supflag) {
                    feeamount = daoFactory.getRegistrationParametersDAO().getParametersValue(instituteid, "SUBREG4.1");
                    feeamountfrom = "fixed4.1";
                } else {
                    feeamount = daoFactory.getRegistrationParametersDAO().getParametersValue(instituteid, "SUBREG4.2");
                    feeamountfrom = "fixed4.2";
                }
                ...
                list.add("Please Check and Correct the value of Parameter SUBREG3.3 in Registration Parameters Form...!");
                return list;
            }
            if (feeamount.equals("")) {
                if (feeamountfrom.equals("subjectwise")) {
                    ...
                    return list;
                } else if (feeamountfrom.equals("fixed4.1")) {
                    list.add("Back Paper fee is not define for Parameter SUBREG4.1 in Registration Parameters Form...");
                    return list;
                } else if (feeamountfrom.equals("fixed4.2")) {
                    list.add("Back Paper fee is not define for Parameter SUBREG4.2 in Registration Parameters Form...");
                    return list;
                }
            }
            ...
            dlist = (List<Object[]>) daoFactory.getSubjectMasterDAO().getBasketStyTypeStyno(instituteid, parentregistrationid, studentid, subjectid);
            if (dlist.size() > 0) {
                ...
                for (int i = 0; i < dlist.size(); i++) {
                    ...
                    stytypeid = obj[1] != null ? obj[1].toString() : "";
                    styno = obj[2] != null ? obj[2].toString() : "";
                    subsectionid = obj[3] != null ? obj[3].toString() : "";
                    subjecttype = obj[4] != null ? obj[4].toString() : "";
                    subjecttypeid = obj[5] != null ? obj[5].toString() : "";
                }
                ...
                if (!feefinilized.equals("Y")) {
                    ...
                    List pstlist = daoFactory.getProgramSubjectTaggingDAO().getPSTDetail(instituteid, pstagid, registrationid);
                    if (pstlist.size() == 0) {
                        ...
                        list = daoFactory.getProgramSubjectTaggingDAO().doValidate(pstdto, "normal");
                        if (list.size() > 0) {
...
//                            return list;
                        ...
                        set = new HashSet();
                        HashMap data1 = null;
                        list1 = (List) daoFactory.getProgramSchemeDAO().getSubjectTaggingList(instituteid, sobj[2].toString(), sobj[5].toString(), sobj[0].toString(), new Byte(failstyno), basketid, parentregistrationid, subjectid);
                        if (list1.size() > 0) {
                    ...
                    if (mdto == null) {
                        ...
                        if (reasontype.equals("0")) { // [0] Other Reason
                            ...
                            fsti.setSourcetransaction("Supplementary Subject Entry");
                ...
                list.add("Faculty Subject or Student tagging not found");
            }
        } catch (Exception e) {
            e.printStackTrace();
            list.add("Error");
